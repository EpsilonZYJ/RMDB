                    ...
                    if (!proj_cols.empty()) {
                        ...
                        if (!already_projected) {
                            auto proj_plan = std::make_shared<ProjectionPlan>(
                                T_Projection, table_scan_executors[i], proj_cols, query->alias, false);
